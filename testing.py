...
def run_tests():
    ...
    assert test_car_with_fuel.fuel == 10, "Car does not set fuel correctly with initial fuel value"
...
def phrase_to_sentence(phrase):
    """
    Convert a phrase to a sentence, starting with a capital and ending with a period.
